...
const EditMenuDish = ({setNotification, setShow, editMode, reRender, setError, setIsLoaded, currentMenuDish, setMenuDishes, menu_id, setEditMode, setReRender, h }) => {
    ...
    const updateMenuDish = event => {
        ...
        fetch("https://examorderfoodapp.herokuapp.com/api/v1/dishes/" + currentMenuDish.id, {
            ...
            if (response.status === 200) {
                ...
                setReload(true);
                setShow(true);
                setNotification({text:'Dish' + event.target.dish_name.value + 'was updated successfully', status:'success'})
            ...
            .catch(error => {
                console.log(error)
                setShow(true);
                setNotification({text:'Dish' + event.target.dish_name.value + 'wasn\t updated due some error', status:'success'})
            })
    }
    return (
