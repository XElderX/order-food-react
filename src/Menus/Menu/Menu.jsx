...
const Menu = ({functionShowHide, menus, setMenus, editMode, setEditMode, showHide, setShowHide, showAllDishes, setError, setIsLoaded, setReRender, currentMenu, setCurrentMenu}) => {
